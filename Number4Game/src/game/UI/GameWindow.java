...
public class GameWindow extends JFrame {
    ...
    public GameWindow() {
        ...
        JMenu startGame = new JMenu("Játék indítása");
    ...
    private void developerMessage(){
        ...
        developerMessage.setText("Fejlesztette: Korom Pál Gábor (ELTE IK hallgató)");
        messagePanel.add(developerMessage);
        messageWindow.add(messagePanel);
        messageWindow.setSize(350, 70);
